...
func TestChannel_IngestTx_updateOpenState_nativeAsset(t *testing.T) {
	...
	err = initiatorChannel.ingestFormationTx(formationTx, validResultXDR, resultMetaXDR)
	require.NoError(t, err)
	...
	err = initiatorChannel.ingestFormationTx(formationTx, invalidResultXDR, resultMetaXDR)
	require.NoError(t, err)
	assert.Equal(t, OpenStateOpen, initiatorChannel.OpenState())
	require.NoError(t, initiatorChannel.openExecutedWithError)

	// Not the formationTx, should return with no state change.
	declTx, _, _, err := initiatorChannel.openTxs(initiatorChannel.openAgreement.Details)
	require.NoError(t, err)
	resultMetaXDR = ""
	err = initiatorChannel.ingestFormationTx(declTx, validResultXDR, resultMetaXDR)
	require.NoError(t, err)
	assert.Equal(t, OpenStateOpen, initiatorChannel.OpenState())
	require.NoError(t, initiatorChannel.openExecutedWithError)
}
...
func TestChannel_IngestTx_updateOpenState_nonNativeAsset(t *testing.T) {
	...
	// XDR without initiator escrow account should not change state or throw an error.
	...
	assert.Equal(t, OpenStateFailed, initiatorChannel.OpenState())
	...
	err = initiatorChannel.ingestFormationTx(formationTx, validResultXDR, resultMetaXDR)
	require.NoError(t, err)
	assert.EqualError(t, initiatorChannel.openExecutedWithError, "non channel participant signer found")
	assert.Equal(t, OpenStateFailed, initiatorChannel.OpenState())
	...
	err = initiatorChannel.ingestFormationTx(formationTx, validResultXDR, resultMetaXDR)
	require.NoError(t, err)
	assert.EqualError(t, initiatorChannel.openExecutedWithError, "incorrect trustline asset found for nonnative asset channel")
	assert.Equal(t, OpenStateFailed, initiatorChannel.OpenState())
	...
	err = initiatorChannel.ingestFormationTx(formationTx, validResultXDR, resultMetaXDR)
	require.NoError(t, err)
	assert.EqualError(t, initiatorChannel.openExecutedWithError, "incorrect trustline flag, needs to be authorized")
	assert.Equal(t, OpenStateFailed, initiatorChannel.OpenState())
}

func TestChannel_IngestTx_updateOpenState_invalid_initiatorEscrowHasExtraSigner(t *testing.T) {
