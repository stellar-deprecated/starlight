...
func TestChannel_IngestTx_updateBalances(t *testing.T) {
	...
	initiatorChannel.ingestTxMetaToUpdateBalances(paymentResultMeta)
	...
	initiatorChannel.ingestTxMetaToUpdateBalances(claimableBalanceResultMeta)
	...
	initiatorChannel.ingestTxMetaToUpdateBalances(pathPaymentSendResultMeta)
	assert.Equal(t, int64(10_060_0000000), initiatorChannel.localEscrowAccount.Balance)
	...
	initiatorChannel.ingestTxMetaToUpdateBalances(noOpResultMeta)
	assert.Equal(t, int64(10_060_0000000), initiatorChannel.localEscrowAccount.Balance)
	assert.Equal(t, int64(10_100_0000000), initiatorChannel.remoteEscrowAccount.Balance)
	...
	initiatorChannel.ingestTxMetaToUpdateBalances(withdrawalResultMeta)
	...
	initiatorChannel.ingestTxMetaToUpdateBalances("")
	assert.Equal(t, int64(10_060_0000000), initiatorChannel.localEscrowAccount.Balance)
	assert.Equal(t, int64(9_100_0000000), initiatorChannel.remoteEscrowAccount.Balance)
}
